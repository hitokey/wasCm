...
struct __env_3* __alloc_env3(Value define, Value i, Value int, Value j, Value name){
...
struct __env_2* __alloc_env2(Value define, Value i, Value int, Value j, Value name){
...
struct __env_1* __alloc_env1(Value define, Value i, Value int, Value j, Value name){
...
Value __lambda_3(Value env_731, Value xx) {
  Value tmp_736 ; 
  return (tmp_736 = MakeClosure(__lambda_2,MakeEnv(__alloc_env2(((struct __env_3*)env_731.env.env)->define, ((struct __env_3*)env_731.env.env)->i, ((struct __env_3*)env_731.env.env)->int, ((struct __env_3*)env_731.env.env)->j, ((struct __env_3*)env_731.env.env)->name))),tmp_736.clo.lam(MakeEnv(tmp_736.clo.env),NewCell(xx))) ;
}

Value __lambda_2(Value env_732, Value xx) {
  Value tmp_737 ; 
  return (tmp_737 = MakeClosure(__lambda_1,MakeEnv(__alloc_env1(((struct __env_2*)env_732.env.env)->define, ((struct __env_2*)env_732.env.env)->i, ((struct __env_2*)env_732.env.env)->int, ((struct __env_2*)env_732.env.env)->j, ((struct __env_2*)env_732.env.env)->name))),tmp_737.clo.lam(MakeEnv(tmp_737.clo.env),(*(xx.cell.addr) = MakeFloat(42.0)))) ;
}

Value __lambda_1(Value env_733, Value _73_191) {
  Value tmp_738 ; 
  Value tmp_7310 ; 
  Value tmp_7311 ; 
  Value tmp_7312 ; 
  return (tmp_738 = MakeClosure(__lambda_0,MakeEnv(__alloc_env0())),tmp_738.clo.lam(MakeEnv(tmp_738.clo.env),(tmp_7310 = ((struct __env_1*)env_733.env.env)->define,tmp_7310.clo.lam(MakeEnv(tmp_7310.clo.env),(tmp_7311 = ((struct __env_1*)env_733.env.env)->name,tmp_7311.clo.lam(MakeEnv(tmp_7311.clo.env),((struct __env_1*)env_733.env.env)->i, ((struct __env_1*)env_733.env.env)->j)), (tmp_7312 = ((struct __env_1*)env_733.env.env)->int,tmp_7312.clo.lam(MakeEnv(tmp_7312.clo.env),MakeInt(10), MakeInt(10))))))) ;
}

Value __lambda_0(Value env_734, Value _73_191) {
  Value tmp_739 ; 
  return (tmp_739 = __display,tmp_739.clo.lam(MakeEnv(tmp_739.clo.env),MakeStr("table"))) ;
}
...
for (int i=0; i<argc;i++) {arg[i]= MakeStr(argv[i]) ;}
 ...
 __rdFromStr   = MakePrimitive(__prim_rdFromStr) ;
  (tmp_735 = MakeClosure(__lambda_3,MakeEnv(__alloc_env3(define, i, int, j, name))),tmp_735.clo.lam(MakeEnv(tmp_735.clo.env),MakeBoolean(0))) ;
  return 0;
 }
