...
struct __env_5* __alloc_env5(Value xx){
...
struct __env_4* __alloc_env4(Value fadd){
...
struct __env_2* __alloc_env2(Value fadd, Value xx){
...
struct __env_1* __alloc_env1(Value fadd, Value xx){
...
double floopsum(Value env,int ix,Value sx,double facc){
return __isNil(env,sx) ? facc : floopsum(env,(ix - 1),__prim_pairCdr(env, sx),(__fl(__prim_pairCar(env, sx)) + facc));}

Value __prim_floopsum(Value env,Value ix,Value sx,Value facc){
return MakeFloat(floopsum(env, ix.z.value, sx, facc.f.value)) ;
}
...
Value __lambda_6(Value env_7319, Value fadd, Value xx) {
  Value tmp_7327 ; 
  return (tmp_7327 = MakeClosure(__lambda_5,MakeEnv(__alloc_env5(xx))),tmp_7327.clo.lam(MakeEnv(tmp_7327.clo.env),NewCell(fadd))) ;
}

Value __lambda_5(Value env_7320, Value fadd) {
  Value tmp_7328 ; 
  return (tmp_7328 = MakeClosure(__lambda_4,MakeEnv(__alloc_env4(fadd))),tmp_7328.clo.lam(MakeEnv(tmp_7328.clo.env),NewCell(((struct __env_5*)env_7320.env.env)->xx))) ;
}

Value __lambda_4(Value env_7321, Value xx) {
  Value tmp_7329 ; 
  return (tmp_7329 = MakeClosure(__lambda_2,MakeEnv(__alloc_env2(((struct __env_4*)env_7321.env.env)->fadd, xx))),tmp_7329.clo.lam(MakeEnv(tmp_7329.clo.env),(*(((struct __env_4*)env_7321.env.env)->fadd.cell.addr) = MakeClosure(__lambda_3,MakeEnv(__alloc_env3()))))) ;
}

Value __lambda_3(Value env_7325, Value fx, Value fy) {
  Value tmp_7336 ; 
  return (tmp_7336 = __fsum,tmp_7336.clo.lam(MakeEnv(tmp_7336.clo.env),fx, fy)) ;
}

Value __lambda_2(Value env_7322, Value _73_191) {
  Value tmp_7330 ; 
  return (tmp_7330 = MakeClosure(__lambda_1,MakeEnv(__alloc_env1(((struct __env_2*)env_7322.env.env)->fadd, ((struct __env_2*)env_7322.env.env)->xx))),tmp_7330.clo.lam(MakeEnv(tmp_7330.clo.env),(*(((struct __env_2*)env_7322.env.env)->xx.cell.addr) = MakeFloat(41.0)))) ;
}
...
Value __lambda_1(Value env_7323, Value _73_191) {
  ...
  Value tmp_7334 ; 
  Value tmp_7335 ; 
  return (tmp_7331 = MakeClosure(__lambda_0,MakeEnv(__alloc_env0())),tmp_7331.clo.lam(MakeEnv(tmp_7331.clo.env),(tmp_7334 = __display,tmp_7334.clo.lam(MakeEnv(tmp_7334.clo.env),(tmp_7335 = (*(((struct __env_1*)env_7323.env.env)->fadd.cell.addr)),tmp_7335.clo.lam(MakeEnv(tmp_7335.clo.env),(*(((struct __env_1*)env_7323.env.env)->xx.cell.addr)), MakeFloat(12.5))))))) ;
}

Value __lambda_0(Value env_7324, Value _73_191) {
  Value tmp_7332 ; 
  Value tmp_7333 ; 
  return (tmp_7332 = __display,tmp_7332.clo.lam(MakeEnv(tmp_7332.clo.env),(tmp_7333 = __floop,tmp_7333.clo.lam(MakeEnv(tmp_7333.clo.env),MakeInt(1000000), MakeFloat(0.0))))) ;
}
...
for (int i=0; i<argc;i++) {arg[i]= MakeStr(argv[i]) ;}
 ...
 __rdFromStr   = MakePrimitive(__prim_rdFromStr) ;
  (tmp_7326 = MakeClosure(__lambda_6,MakeEnv(__alloc_env6())),tmp_7326.clo.lam(MakeEnv(tmp_7326.clo.env),MakeBoolean(0), MakeBoolean(0))) ;
  return 0;
 }
